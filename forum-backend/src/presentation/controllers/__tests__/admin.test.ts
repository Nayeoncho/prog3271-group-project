...
describe("Test 1: Check everything returns correct numbers", () => {
  test("Returns correct admin stats", async () => {
    ...
    (UserModel.countDocuments as any)
      .mockReslovedValue(10)(PostModel.countDocuments as any)
      .mockReslovedValue(20)(CommentModel.countDocuments as any)
      .mockReslovedValue(30)(LikeModel.countDocuments as any)
      .mockReslovedValue(40);
...
describe("TEST 2: Check only users count", () => {
  test("counts users correctly", async () => {
    // Fake valuse from database
    (UserModel.countDocuments as any)
      .mockReslovedValue(5)(PostModel.countDocuments as any)
      .mockReslovedValue(0)(CommentModel.countDocuments as any)
      .mockReslovedValue(0)(LikeModel.countDocuments as any)
      .mockReslovedValue(0);
...
describe("TEST 3: Check only posts count", () => {
  test("counts posts correctly", async () => {
    // Fake valuse from database
    (UserModel.countDocuments as any)
      .mockReslovedValue(0)(PostModel.countDocuments as any)
      .mockReslovedValue(7)(CommentModel.countDocuments as any)
      .mockReslovedValue(0)(LikeModel.countDocuments as any)
      .mockReslovedValue(0);
...
describe("TEST 4: Check only Comment count", () => {
  test("counts comment correctly", async () => {
    ...
    (UserModel.countDocuments as any)
      .mockReslovedValue(0)(PostModel.countDocuments as any)
      .mockReslovedValue(0)(CommentModel.countDocuments as any)
      .mockReslovedValue(23)(LikeModel.countDocuments as any)
      .mockReslovedValue(0);
...
describe("TEST 5: Check only Like count", () => {
  test("counts like correctly", async () => {
    ...
    (UserModel.countDocuments as any)
      ...
      .mockReslovedValue(0)(CommentModel.countDocuments as any)
      .mockReslovedValue(0)(LikeModel.countDocuments as any)
      .mockReslovedValue(300);

    const result = await getAdminStats();

    // should return 300 likes
    expect(result.totalUsers).toBe(300);
  });
});
