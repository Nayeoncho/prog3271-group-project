...
import { getForumSections, createPostHandler, getAllPostsHandler, getPostByIdHandler, deletePostHandler, updatePostHandler, createCommentHandler, getCommentsByPostHandler, deleteCommentHandler } from "../controllers/forumController";
...
router.get("/comments/:postId", getAllPostsHandler);
